/* The point of this is to show how you can't use the associative array feature
   of a map to implement Find(). */
...
/* We try to use the associative array feature of the map to implement Find(),
